...
aws s3 cp --acl public-read --content-type "text/css" plugins/leaflet-locatecontrol/v0.43.0/css/font-awesome.css s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/css/font-awesome.css
aws s3 cp --acl public-read --content-type "text/css" plugins/leaflet-locatecontrol/v0.43.0/css/font-awesome.min.css s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/css/font-awesome.min.css
aws s3 cp --acl public-read --content-type "application/vnd.ms-fontobject" plugins/leaflet-locatecontrol/v0.43.0/fonts/fontawesome-webfont.eot s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/fonts/fontawesome-webfont.eot
aws s3 cp --acl public-read --content-type "image/svg+xml" plugins/leaflet-locatecontrol/v0.43.0/fonts/fontawesome-webfont.svg s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/fonts/fontawesome-webfont.svg
aws s3 cp --acl public-read --content-type "application/x-font-ttf" plugins/leaflet-locatecontrol/v0.43.0/fonts/fontawesome-webfont.ttf s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/fonts/fontawesome-webfont.ttf
aws s3 cp --acl public-read --content-type "application/font-woff" plugins/leaflet-locatecontrol/v0.43.0/fonts/fontawesome-webfont.woff s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/fonts/fontawesome-webfont.woff
aws s3 cp --acl public-read --content-type "application/octet-stream" plugins/leaflet-locatecontrol/v0.43.0/fonts/fontawesome-webfont.woff2 s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/fonts/fontawesome-webfont.woff2
aws s3 cp --acl public-read --content-type "font/opentype" plugins/leaflet-locatecontrol/v0.43.0/fonts/FontAwesome.otf s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/fonts/FontAwesome.otf
aws s3 cp --acl public-read --content-type "text/css" plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.css s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.css
aws s3 cp --acl public-read --content-type "text/css" plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.ie.css s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.ie.css
aws s3 cp --acl public-read --content-type "text/css" plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.ie.min.css s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.ie.min.css
aws s3 cp --acl public-read --content-type "application/octet-stream" plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.ie.min.css.map s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.ie.min.css.map
aws s3 cp --acl public-read --content-type "text/css" plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.mapbox.css s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.mapbox.css
aws s3 cp --acl public-read --content-type "text/css" plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.mapbox.min.css s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.mapbox.min.css
aws s3 cp --acl public-read --content-type "application/octet-stream" plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.mapbox.min.css.map s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.mapbox.min.css.map
aws s3 cp --acl public-read --content-type "text/css" plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.min.css s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.min.css
aws s3 cp --acl public-read --content-type "application/octet-stream" plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.min.css.map s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.min.css.map
aws s3 cp --acl public-read --content-type "application/javascript" plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.min.js s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.min.js
aws s3 cp --acl public-read --content-type "application/octet-stream" plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.min.js.map s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/L.Control.Locate.min.js.map
...
aws s3 cp --acl public-read --content-type "text/css" plugins/mapbox-directions.js/v0.3.0/mapbox.directions.css s3://mapbox-js/mapbox.js/plugins/mapbox-directions.js/v0.3.0/mapbox.directions.css
aws s3 cp --acl public-read --content-type "application/javascript" plugins/mapbox-directions.js/v0.3.0/mapbox.directions.js s3://mapbox-js/mapbox.js/plugins/mapbox-directions.js/v0.3.0/mapbox.directions.js
aws s3 cp --acl public-read --content-type "image/png" plugins/mapbox-directions.js/v0.3.0/mapbox.directions.png s3://mapbox-js/mapbox.js/plugins/mapbox-directions.js/v0.3.0/mapbox.directions.png
aws s3 cp --acl public-read --content-type "image/svg+xml" plugins/mapbox-directions.js/v0.3.0/mapbox.directions.svg s3://mapbox-js/mapbox.js/plugins/mapbox-directions.js/v0.3.0/mapbox.directions.svg
...
aws s3 cp --acl public-read --content-type "application/javascript" plugins/turf/v2.0.2/turf.min.js s3://mapbox-js/mapbox.js/plugins/turf/v2.0.2/turf.min.js
echo ""
echo ""
