...
s3cmd put --acl-public --mime-type "application/javascript" leaflet-fullscreen/Leaflet.fullscreen.min.js s3://mapbox-js/mapbox.js/plugins/leaflet-fullscreen/v0.0.1/Leaflet.fullscreen.min.js
...
s3cmd put --acl-public --mime-type "application/javascript" leaflet-draw/leaflet.draw.js s3://mapbox-js/mapbox.js/plugins/leaflet-draw/v0.2.2/leaflet.draw.js
...
s3cmd put --acl-public --mime-type "application/javascript" leaflet-markercluster/leaflet.markercluster.js s3://mapbox-js/mapbox.js/plugins/leaflet-markercluster/v0.4.0/leaflet.markercluster.js
