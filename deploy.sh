...
s3cmd put --acl-public --mime-type "application/javascript" plugins/leaflet-fullscreen/v0.0.2/Leaflet.fullscreen.min.js s3://mapbox-js/mapbox.js/plugins/leaflet-fullscreen/v0.0.2/Leaflet.fullscreen.min.js
s3cmd put --acl-public --mime-type "text/css" plugins/leaflet-fullscreen/v0.0.2/leaflet.fullscreen.css s3://mapbox-js/mapbox.js/plugins/leaflet-fullscreen/v0.0.2/leaflet.fullscreen.css
s3cmd put --acl-public --mime-type "image/png" plugins/leaflet-fullscreen/v0.0.2/fullscreen@2x.png s3://mapbox-js/mapbox.js/plugins/leaflet-fullscreen/v0.0.2/fullscreen@2x.png
s3cmd put --acl-public --mime-type "image/png" plugins/leaflet-fullscreen/v0.0.2/fullscreen.png s3://mapbox-js/mapbox.js/plugins/leaflet-fullscreen/v0.0.2/fullscreen.png
...
s3cmd put --acl-public --mime-type "application/javascript" plugins/leaflet-omnivore/v0.1.1/leaflet-omnivore.min.js s3://mapbox-js/mapbox.js/plugins/leaflet-omnivore/v0.1.1/leaflet-omnivore.min.js
s3cmd put --acl-public --mime-type "application/javascript" plugins/leaflet-omnivore/v0.1.1/leaflet-omnivore.js s3://mapbox-js/mapbox.js/plugins/leaflet-omnivore/v0.1.1/leaflet-omnivore.js
