...
aws s3 cp --acl public-read --content-type "application/vnd.ms-fontobject" plugins/leaflet-locatecontrol/v0.43.0/font/fontawesome-webfont.eot s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/font/fontawesome-webfont.eot
aws s3 cp --acl public-read --content-type "image/svg+xml" plugins/leaflet-locatecontrol/v0.43.0/font/fontawesome-webfont.svg s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/font/fontawesome-webfont.svg
aws s3 cp --acl public-read --content-type "application/x-font-ttf" plugins/leaflet-locatecontrol/v0.43.0/font/fontawesome-webfont.ttf s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/font/fontawesome-webfont.ttf
aws s3 cp --acl public-read --content-type "application/font-woff" plugins/leaflet-locatecontrol/v0.43.0/font/fontawesome-webfont.woff s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/font/fontawesome-webfont.woff
aws s3 cp --acl public-read --content-type "application/octet-stream" plugins/leaflet-locatecontrol/v0.43.0/font/fontawesome-webfont.woff2 s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/font/fontawesome-webfont.woff2
aws s3 cp --acl public-read --content-type "font/opentype" plugins/leaflet-locatecontrol/v0.43.0/font/FontAwesome.otf s3://mapbox-js/mapbox.js/plugins/leaflet-locatecontrol/v0.43.0/font/FontAwesome.otf
